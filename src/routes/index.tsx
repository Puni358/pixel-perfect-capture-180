...
import { ArrowRight, Bot, IndianRupee, Percent, TrendingUp, TriangleAlert } from "lucide-react";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Overview — RecoverAI Revenue Recovery" },
      {
        ...
        content: "Turn failed payments into recovered revenue with an approval-gated AI agent.",
      },
    ],
  }),
  component: Overview,
    ...
    <AppShell>
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            ...
            <span className="font-medium text-foreground">{inr(metrics.revenueAtRisk)}</span>.
          </p>
        </div>
        <AgentStatusBadge />
      </div>
        ...
        <div className="flex flex-wrap items-start gap-6 p-5 lg:p-6">
          ...
          <div className="min-w-[240px] flex-1">
            ...
            <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
              Your AI agent continuously identifies failed payments, abandoned checkouts and
              subscription failures, then recommends the safest recovery action.
            </p>
            <div className="mt-4">
          ...
          >
            Open AI Agent <ArrowRight className="size-4" />
          </Link>
        </div>
      </section>
      ...
      <section className="mt-6">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            <h2 className="text-lg font-semibold tracking-tight">Revenue Opportunities</h2>
        ...
        <div className="panel mt-3 overflow-hidden">
          <OpportunityTableHeader />
          {opportunities.map((o) => (
            <OpportunityRow key={o.id} opportunity={o} customer={customerOf(o)} />
          ))}
        </div>
      </section>
    </AppShell>
